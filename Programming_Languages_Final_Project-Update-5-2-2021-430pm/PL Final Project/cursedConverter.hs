...
data Token = Class | MainM | VSym String | Csym Integer | LPar | RPar | LBra |
             ...
             Op Ops | Err | PA AExpr | PB BExpr | Declaration CVars
  deriving Show
...
-- (Less Then) BExpr -> AExpr < AExpr  
sr :: [Token] -> [Token] -> [Token]
sr (PA x:Op LesserOp:PA y:stack) input = sr (PB (Lt y x):stack) input

------ Test Zero ---------
testParse = [Keyword "class",VSym "Student",LBra,Keyword "public",Type Str,VSym "name",Semi,Keyword "public",Type Int,VSym "age",Semi,Keyword "public",VSym "Student",LPar,Type Str,VSym "n",Com,Type Int,VSym "a",RPar,LBra,VSym "name",Op AssignOp,VSym "n",Semi,VSym "age",Op AssignOp,VSym "a",Semi,RBra,Keyword "public",Type Str,VSym "getName",LPar,RPar,LBra,Keyword "return",VSym "name",Semi,RBra,Keyword "public",Keyword "void",VSym "setName",LPar,Type Str,VSym "n",RPar,LBra,Keyword "this",Op DotOp,VSym "name",Op AssignOp,VSym "n",Semi,RBra,Keyword "public",Type Int,VSym "getAge",LPar,RPar,LBra,Keyword "return",VSym "age",Semi,RBra,Keyword "public",Keyword "void",VSym "setAge",LPar,Type Int,VSym "a",RPar,LBra,Keyword "this",Op DotOp,VSym "age",Op AssignOp,VSym "a",Semi,RBra,RBra,Keyword "public",Keyword "class",Keyword "main",LBra,Keyword "public",Keyword "static",Keyword "void",Keyword "main",LPar,Type Str,Brac,Keyword "args",RPar,LBra,VSym "Student",VSym "Jacob",Op AssignOp,Keyword "new",VSym "Student",LPar,Qut,VSym "Jacob",Qut,Com,Csym 100,RPar,Semi,VSym "Student",VSym "Wolfe",Op AssignOp,Keyword "new",VSym "Student",LPar,Qut,VSym "Wolfe",Qut,Com,Csym 999,RPar,Semi,VSym "Student",VSym "Luke",Op AssignOp,Keyword "new",VSym "Student",LPar,Qut,VSym "Luke",Qut,Com,Csym 2,RPar,Semi,VSym "Jacob",Op DotOp,VSym "setAge",LPar,VSym "Wolfe",Op DotOp,VSym "getAge",LPar,RPar,Op SubOp,VSym "Luke",Op DotOp,VSym "getAge",LPar,RPar,RPar,Semi,VSym "System",Op DotOp,Keyword "out",Op DotOp,Keyword "print",LPar,VSym "Jacob",Op DotOp,VSym "getAge",LPar,RPar,RPar,Semi,RBra,RBra]
